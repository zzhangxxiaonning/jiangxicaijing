...
//	public $JS_API_CALL_URL = 'http://121.43.116.138/weipay/index.php/home/index/notify';
    ...
    public $NOTIFY_URL = 'http://www.bimfree.com/Wxpay/notify';
//    public $NOTIFY_URL = 'http://'.$_SERVER['HTTP_HOST'].'/Wxpay/notify';
//    public $NOTIFY_URL = 'http://putao.ibangoo.com/abc.php';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
//			$this->APPID = 'wx4445d003dbaff66d';
			$this->APPID = 'wx22cdb81eeb37aa07';
			//受理商ID，身份标识
//			$this->MCHID = '1441630602';
			$this->MCHID = '1362962002';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
//			$this->KEY = 'Ibangoo1233333333333333333333333';
			$this->KEY = 'bimfree1233333333333333333333333';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
//			$this->APPSECRET = '04a5a76ae467edd0dfb4d6b10709c6ba';
			$this->APPSECRET = '8b52d813cc5832600c67ad2f59e71c4c';
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
