...
Class FlashModel extends Model{
	...
	protected  $_validate =array(
		...
		array('rank_id','require','请选择级别！',0,'',3),
		array('start_time','require','请填写开始时间',0,'',3),
		array('end_time','require','请填写结束时间',0,'',3),
	...
	protected $_auto = array (
		...
		array('start_time','time_get',3,'callback'), //开始时间	
		array('end_time','time_get',3,'callback'),//结束时间
